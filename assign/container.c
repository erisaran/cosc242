/**
   242 assignment container file.
   Code for building containers of either flexarrays or red-black trees.
...
/**
   @brief A container struct to store a type and its contents.
*/
struct containerrec {
    container_t type;
    void *contents;
